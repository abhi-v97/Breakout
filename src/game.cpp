...
void Game::Init()
{
    ...
    ResourceManager::LoadTexture("res/powerup_speed.png", true, "powerup_speed");
    ResourceManager::LoadTexture("res/powerup_sticky.png", true, "powerup_sticky");
    ResourceManager::LoadTexture("res/powerup_increase.png", true, "powerup_increase");
    ResourceManager::LoadTexture("res/powerup_confuse.png", true, "powerup_confuse");
    ResourceManager::LoadTexture("res/powerup_chaos.png", true, "powerup_chaos");
    ResourceManager::LoadTexture("res/powerup_passthrough.png", true, "powerup_passthrough");
    ...
    // load level
    GameLevel one; one.Load("res/one.lvl", this->Width, this->Height * 0.5);
    ...
    Text->Load("res/ocraext.TTF", 24);
}

// check and update current game state
...
{
    this->Levels[0].Load("res/one.lvl", this->Width, this->Height * 0.5);
    this->Lives = 3;
}

// Reset paddle and ball back to starting position
...
void Game::Render()
{
    ...
    if (this->State == GAME_MENU)
    {
        ...
        Text->RenderText("SPACE to fire, A and D to move", 245.0f, this->Height / 2.0f + 20.0f, 0.75f);
    }
    if (this->State == GAME_WIN)
    {
...
// move powerup after its spawned, disable it after time up.
...
// creates PowerUp object based on chance and sets the properties
// each powerup is given a colour and position of the brick that spawned it
...
// Enables the powerup upon collision
...
// check for collision with brick and paddle
